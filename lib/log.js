...
Log.prototype.addBuildEvent = function(timestamp, player, object) {
  player = this._addRoleInfoToPlayerObject(player);
  var e = {timestamp: timestamp, elapsedSeconds: parsingUtils.getTimestampDifference(timestamp, this._log.gameStartTimestamp), type: 'builtobject', player: player, object: object};
  this._log.events.push(e);
  if(this.calculateDeltas) this._deltas.push(e);
};
