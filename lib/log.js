...
Log.prototype.addSayEvent = function(timestamp, player, text) {
  ...
  this._log.events.push({timestamp: timestamp, elapsedSeconds: parsingUtils.getTimestampDifference(timestamp, this._log.gameStartTimestamp), type: 'say', player: player, text: text});
};
...
Log.prototype.addSayTeamEvent = function(timestamp, player, text) {
  player = this._addRoleInfoToPlayerObject(player);
  this._log.events.push({timestamp: timestamp, elapsedSeconds: parsingUtils.getTimestampDifference(timestamp, this._log.gameStartTimestamp), type: 'say_team', player: player, text: text});
};
...
Log.prototype.addKillEvent = function(timestamp, player, victim, weapon_key, customKill) {
  ...
  this._log.events.push({timestamp: timestamp, elapsedSeconds: parsingUtils.getTimestampDifference(timestamp, this._log.gameStartTimestamp), type: 'kill', player: player, victim: victim, assister: false, weapon: weapon_key, customKill: customKill});
};
...
Log.prototype.addDominationEvent = function(timestamp, player, victim) {
  player = this._addRoleInfoToPlayerObject(player);
  victim = this._addRoleInfoToPlayerObject(victim);
  this._log.events.push({timestamp: timestamp, elapsedSeconds: parsingUtils.getTimestampDifference(timestamp, this._log.gameStartTimestamp), type: 'domination', player: player, victim: victim});
};
...
Log.prototype.addRevengeEvent = function(timestamp, player, victim) {
  player = this._addRoleInfoToPlayerObject(player);
  victim = this._addRoleInfoToPlayerObject(victim);
  this._log.events.push({timestamp: timestamp, elapsedSeconds: parsingUtils.getTimestampDifference(timestamp, this._log.gameStartTimestamp), type: 'revenge', player: player, victim: victim});
};
...
Log.prototype.addExtinguishEvent = function(timestamp, player, victim, weapon_key) {
  player = this._addRoleInfoToPlayerObject(player);
  victim = this._addRoleInfoToPlayerObject(victim);
  this._log.events.push({timestamp: timestamp, elapsedSeconds: parsingUtils.getTimestampDifference(timestamp, this._log.gameStartTimestamp), type: 'exinguished', player: player, victim: victim, weapon: weapon_key});
};
...
*/
Log.prototype.addBuildEvent = function(timestamp, player, object) {
  player = this._addRoleInfoToPlayerObject(player);
  this._log.events.push({timestamp: timestamp, elapsedSeconds: parsingUtils.getTimestampDifference(timestamp, this._log.gameStartTimestamp), type: 'builtobject', player: player, object: object});
};
...
Log.prototype.addUberchargeEvent = function(timestamp, player) {
  player = this._addRoleInfoToPlayerObject(player);
  this._log.events.push({timestamp: timestamp, elapsedSeconds: parsingUtils.getTimestampDifference(timestamp, this._log.gameStartTimestamp), type: 'chargedeployed', player: player});
};
...
Log.prototype.addPointCapturedEvent = function(timestamp, team, cpname, players) {
  ...
  this._log.events.push({timestamp: timestamp, elapsedSeconds: parsingUtils.getTimestampDifference(timestamp, this._log.gameStartTimestamp), type: 'pointcaptured', team: team, cpname: cpname, players: players});
};
...
Log.prototype.addCaptureBlockedEvent = function(timestamp, player, cpname) {
  player = this._addRoleInfoToPlayerObject(player);
  this._log.events.push({timestamp: timestamp, elapsedSeconds: parsingUtils.getTimestampDifference(timestamp, this._log.gameStartTimestamp), type: 'captureblocked', player: player, cpname: cpname});
};
...
Log.prototype.addFlagDefendedEvent = function(timestamp, player) {
  player = this._addRoleInfoToPlayerObject(player);
  this._log.events.push({timestamp: timestamp, elapsedSeconds: parsingUtils.getTimestampDifference(timestamp, this._log.gameStartTimestamp), type: 'flagdefended', player: player});
};
...
Log.prototype.addFlagCapturedEvent = function(timestamp, player) {
  player = this._addRoleInfoToPlayerObject(player);
  this._log.events.push({timestamp: timestamp, elapsedSeconds: parsingUtils.getTimestampDifference(timestamp, this._log.gameStartTimestamp), type: 'flagcaptured', player: player});
};
...
Log.prototype.addFlagPickedUpEvent = function(timestamp, player) {
  player = this._addRoleInfoToPlayerObject(player);
  this._log.events.push({timestamp: timestamp, elapsedSeconds: parsingUtils.getTimestampDifference(timestamp, this._log.gameStartTimestamp), type: 'flagpickedup', player: player});
};
...
Log.prototype.addFlagDroppedEvent = function(timestamp, player) {
  player = this._addRoleInfoToPlayerObject(player);
  this._log.events.push({timestamp: timestamp, elapsedSeconds: parsingUtils.getTimestampDifference(timestamp, this._log.gameStartTimestamp), type: 'flagdropped', player: player});
};
...
Log.prototype.addPositionEvent = function(timestamp, player, position) {
  player = this._addRoleInfoToPlayerObject(player);
  this._log.positions.push({timestamp: timestamp, elapsedSeconds: parsingUtils.getTimestampDifference(timestamp, this._log.gameStartTimestamp), player: player, position: position});
};
...
*/
Log.prototype.addUpdateRoleToPlayer = function(steamid, role, timestamp) {
  if(!steamid || !role || !timestamp) return;
  ...
  if(!foundPlayer.role) {
    this._updateRoleToEvents(steamid, role);
  }
