...
function Log() {
  ...
  */
  ...
  /**
    ...
    @param increment Optional. If not specified, the given stat is incremented by 1. Otherwise, the value given here is added to the stat specified.
  */
  this.incrementWeaponSpreadToPlayer = function(steamid, weapon, statToIncrement, increment) {
    ...
    if(foundPlayer.weaponSpread[weapon.key] === undefined) {
      foundPlayer.weaponSpread[weapon.key] = {
        key: weapon.key,
        kills: 0,
        deaths: 0
      };
    ...
    foundPlayer.weaponSpread[weapon.key][statToIncrement] += increment;
  };
