...
function Log() {
  ...
  */
  this.addKillEvent = function(timestamp, player, victim, weapon_key, customKill) {
    _log.events.push({timestamp: timestamp, type: 'kill', player: player, victim: victim, weapon: weapon_key, customKill: customKill});
  };
  ...
  */ 
  this.addExtinguishEvent = function(timestamp, player, victim, weapon_key) {
    _log.events.push({timestamp: timestamp, type: 'exinguished', player: player, victim: victim, weapon: weapon_key});
  };
