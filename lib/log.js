...
function Log() {
  ...
  */
  this.addKillEvent = function(timestamp, player, victim, weapon_key, customKill) {
    _log.events.push({timestamp: timestamp, elapsedSeconds: parsingUtils.getTimestampDifference(timestamp, _log.gameStartTimestamp), type: 'kill', player: player, victim: victim, weapon: weapon_key, customKill: customKill});
  };
  ...
  */ 
  this.addAssistEvent = function(timestamp, player, victim, customKill) {
    ...
    _log.events.push({timestamp: timestamp, elapsedSeconds: parsingUtils.getTimestampDifference(timestamp, _log.gameStartTimestamp), type: 'assist', player: player, victim: victim, customKill: customKill});
  };
