...
module.exports.getKillCoords = function(logLineDetails, type) {
  if(typeof logLineDetails != 'string') return false;
  var pos = getParenValue(logLineDetails, type+'_position');
...
/**
  ...
  @param logLineDetails result from ParsingUtils#getLogLineDetails
*/
module.exports.getReportedPosition = function(logLineDetails, type) {
  if(typeof logLineDetails != 'string') return false;
  var pos = getParenValue(logLineDetails, 'position');
  if(pos === false) return false;
  pos = pos.split(' ');
  return [parseInt(pos[0], 10), parseInt(pos[1], 10), parseInt(pos[2], 10)];
};
...
/**
  ...
  @param logLineDetails result from ParsingUtils#getLogLineDetails
*/
module.exports.getPlayers = function(logLineDetails) {
  if(typeof logLineDetails != 'string') return false;
  ...
  while(matches = regexp.exec(logLineDetails)) {
    ...
    if(matches[3] == 'BOT') matches[3] = 'BOT:' + matches[1];
