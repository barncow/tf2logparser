      ...
      var logLineDetails = parsingUtils.getLogLineDetails(logLine), players = null;
        ...
        if(parsingUtils.isLogLineOfType(logLineDetails, '"')) {
          ...
          if(playerLineAction == 'position_report') {
            ...
            _log.incrementWeaponSpreadToPlayer(attacker.steamid, weapon, 'kills');
            _log.incrementWeaponSpreadToPlayer(victim.steamid, weapon, 'deaths');
            ...
            _log.incrementWeaponSpreadToPlayer(players[0].steamid, weapon, 'deaths');
            _log.addWeapon(weapon);
